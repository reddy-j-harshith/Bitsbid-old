				...
				<div class="entry">
				  <div class="post_content">
				    ...
				    <div align="center" class="style5 style14">
                      <div align="center"><span class="style15"><a href="SearchPostsDetails1.jsp?p_Name=<%=p_Name%>&amp;keyword=<%=l_Input%>&amp;p_Categorie=<%=p_Categorie%>" class="style56 style30"><strong>View Details</strong></a></span></div>
			        </div>
				    <div align="center">
                      </p>
                    </div>
