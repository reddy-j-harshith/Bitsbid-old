...
String credit="";
			...
			if(rs.next())
			{
								...
								String sql1="SELECT * FROM cart where (p_name='"+p_Name+"' and categorie='"+p_Categorie+"')";
								Statement stmt1 = connection.createStatement();
								ResultSet rs1 =stmt.executeQuery(sql1);
								if(rs1.next()==true)
								{
										pprice=Integer.parseInt(rs1.getString(8));
										if(pprice>uamount)
										{
											 %><br/><%
									...
									else
									{
											...
											out.print("Product Details Not Found..");
											 %><br/><br/><a href="U_MyCartProducts1111.jsp">Back</a><%
