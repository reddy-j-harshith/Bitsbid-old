...
<td height="39" ><div align="center" class="style70 style73"><span class="style70">Product Name</span></div></td>
                      <td width="307"><div align="center" class="style84"><%= pro%></div></td>
                    </tr>
                    <tr >
                      <td height="37" ><div align="center" class="style70"> Basic Price </div></td>
                      <td><div align="center" class="style84"><%= price%> Rs/-</div></td>
                    </tr>
                    <tr >
                      <td height="47" ><div align="center" class="style70">Highest Price</div></td>
                      <td><div align="center" class="style84"><%= uses%> Rs/-</div>
...
%>
				   ...
				   <div align="right"><a href="U_viewposts.jsp" class="style11"></a><a href="U_viewposts.jsp" class="style11"><strong>Back</strong></a></div>
			  </div>
		  </div>
	  </div>
		<!-- end #content -->
